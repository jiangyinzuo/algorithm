...
int trie_tree[100005][26] = {0};
int people_count[100005] = {0};
int people_count_prefix[100005] = {0};
long long people_fame[100005] = {0};
long long people_fame_prefix[100005] = {0};
int update_mark[100005] = {0};
int node_count = 0;
...
void push_down(int cur_node)
{
    ...
    people_fame[cur_node] += people_count[cur_node] * update_mark[cur_node];
    people_fame_prefix[cur_node] += people_count_prefix[cur_node] * update_mark[cur_node];
